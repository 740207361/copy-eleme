  ...
  <div v-show="showFlag" class="food" ref="food">
    <div class="food-content">
      ...
      <div class="rating">
        ...
        :desc="desc" :rating="food.ratings"></ratingselect>
        <div class="rating-wrapper">
          <ul v-show="food.ratings && food.ratings.length" class="">
            <li v-show="needShow(rating.rateType, rating.text)" v-for="rating in food.ratings" class="rating-item" :key="rating.index">
              <div class="user">
